...
import { navigationLinks, contactInfo, socialMedia, companyInfo } from '../../config/siteConfig';
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            >
              <DirectionsBoatIcon sx={{ fontSize: '2.5rem', color: '#B0E0E6', mr: 1 }} />
              <Typography 
                variant="h4" 
                sx={{ 
                  fontWeight: 700,
            ...
            <Box sx={{ 
              ...
              {/* Navigation Links with center alignment */}
              <Box sx={{ 
                display: 'flex',
                flexDirection: 'column',
                alignItems: 'center',
              ...
              <Grid container spacing={2} justifyContent="center" alignItems="center">
                {contactInfo.slice(0, 2).map((contact, index) => (
                  <Grid key={index} item xs={12} sm={6} md={4} sx={{ textAlign: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: { xs: 'center', sm: 'flex-start', md: index === 1 ? 'center' : 'flex-start' }, mb: { xs: 2, sm: 0 } }}>
